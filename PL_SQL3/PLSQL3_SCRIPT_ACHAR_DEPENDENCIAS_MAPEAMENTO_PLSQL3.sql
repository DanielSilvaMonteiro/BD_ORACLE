/*
CAMINHO PARA VER AS DEPENDENCIAS
C:\app\monte\product\21c\dbhomeXE\rdbms\admin
NOME DO ARQUIVO : UTLDTREE
AO RODAR O ARQUIVO EM USER_DEV QUE É O USUARIO MASTER,
OCORRERAO ALGUNS ERROS O IMPORTANTE E A CRIACAO DAS DEPENDENCIAS NA TABELA IDEPTREE
AS VIEWS DEPTREE E IDEPTREE
PROCEDURES DEPTRRE_FILL
*/
