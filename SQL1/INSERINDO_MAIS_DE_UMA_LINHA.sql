...
VALUES
('1040112', 'Light - 450 ml - Manga', 5.80, '450 ml', 'Lata', 'Manga')
INTO PRODUTOS
(CODIGO, DESCRITOR, PRECO_LISTA, TAMANHO, EMBALAGEM, SABOR)
VALUES
('1040113', 'Light - 450 ml - Melancia', 5.90, '450 ml', 'Lata', 'Melancia')
INTO PRODUTOS
(CODIGO, DESCRITOR, PRECO_LISTA, TAMANHO, EMBALAGEM, SABOR)
VALUES
('1040114', 'Light - 450 ml - Maca', 6.80, '450 ml', 'Lata', 'Maca')
SELECT * FROM DUAL;
...
--****************************************************************************
--CRIANDO A TABELA_DE_PRODUTOS_FONTE, INSERINDO_DADOS_SQL
...
--PARA USAR A TABELAS FONTE EM PRODUTOS, OS CAMPOS PRECISAM TER OS MESMOS NOMES
SELECT * FROM PRODUTOS;
SELECT * FROM TABELA_DE_PRODUTOS_FONTE;

--CASO OCORRA UM ERRO ELE ABORTA O RESULTADO
