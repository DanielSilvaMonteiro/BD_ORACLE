...
--UASNDO SUBSTR PARA RETIRAR OS DOIS ZEROS A ESQUERDA
...
---ATUALIZAR NAS DUAS TABELASAUTOMATICAMENTE ESTE EXEMPLO NAO FUNCIONA -- tem continuação
UPDATE VENDEDORES V 
INNER JOIN TABELA_DE_VENDEDORES TVF
ON V.MATRICULA = SUBSTR(TVF.MATRICULA, 3,3)
