...
add cod_item varchar2(10);
alter table f_ped_item
add nro_pedido varchar2(10);
...
add nro_regiao varchar2(10);
alter table f_cliente
add cod_municipio varchar2(10);
alter table f_cliente
add cod_distrito varchar2(10);
...
add sig_uf varchar2(10);
alter table f_municipio
add cod_pais varchar2(10);
