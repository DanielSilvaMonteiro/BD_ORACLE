...
--ERRO FATURAMENTO NULO, O IDEAL SERIA O CAMPO NAO ACEITAR NULO, MAS
--VAMOS SEUIR QUE EXISTAM MUITOS CLIENTES COM VALOR NULO, ENTAO VAMOS CRIAR UMA EXCESSAO PL/SQL
EXECUTE INCLUIR_CLIENTE(20, 'CLIENTE NULO TESTE', '5498695486', 1, NULL);
...
EXCEPTION
    ...
    WHEN E_FATURAMENTO_NULO THEN
        RAISE_APPLICATION_ERROR(-20025, 'FATURAMENTO POSSUI VALOR NULO');
    WHEN OTHERS THEN
